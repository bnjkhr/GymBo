...
//  SwiftData Migration - Version 2.0.0
//

import Foundation
import SwiftData

/// Schema Version 2.0.0 - Add exerciseId to WorkoutExerciseEntity
///
/// **Purpose:**
/// - Add direct exerciseId field to WorkoutExerciseEntity for reliable lookups
/// - Fixes issue where exercise names weren't loading due to lazy relationship loading
///
/// **Changes from V1:**
/// - WorkoutExerciseEntity: Added `exerciseId: UUID` field
///
/// **Migration:**
/// - Lightweight migration (add non-optional field with relationship fallback)
/// - exerciseId populated from exercise.id for existing data
///
/// **Created:** 2025-10-23 (Session Continuation)
...
enum SchemaV2: VersionedSchema {
    ...
    // MARK: - UserProfileEntity (unchanged from V1)
