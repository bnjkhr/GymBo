...
//  SwiftData Migration - Version 4.0.0
//

import Foundation
import SwiftData

/// Schema Version 4.0.0 - Warmup Sets Support
///
/// **Purpose:**
/// - Add warmup set tracking to SessionSetEntity
/// - Add restTime field to SessionSetEntity (was missing in V3 schema)
///
/// **Changes from V3:**
/// - SessionSetEntity: Added isWarmup field (Bool, default false)
/// - SessionSetEntity: Added restTime field (TimeInterval?, optional)
///
/// **Migration:**
/// - Lightweight migration (all new fields have defaults)
/// - Existing sets: isWarmup = false, restTime = nil
///
