...
//  SwiftData Migration - Version 5.0.0
//

import Foundation
import SwiftData

/// Schema Version 5.0.0 - Warmup Strategy Persistence
///
/// **Purpose:**
/// - Add warmup strategy field to WorkoutEntity
/// - Allow users to save preferred warmup strategy per workout
///
/// **Changes from V4:**
/// - WorkoutEntity: Added warmupStrategy field (String?, optional)
/// - Stores strategy as string: "standard", "conservative", "minimal", "none"
/// - Default: nil (no automatic warmup)
///
/// **Migration:**
/// - Lightweight migration (all new fields are optional)
/// - Existing workouts: warmupStrategy = nil
///
/// **Created:** 2025-10-30 (Session 32)
...
enum SchemaV5: VersionedSchema {
    ...
    // MARK: - SessionSetEntity (✨ NEW in V4: Added isWarmup and restTime)
    ...
    final class SessionSetEntity {
        ...
        var orderIndex: Int
        var restTime: TimeInterval?  // ✨ NEW: Rest time after this set
        var isWarmup: Bool  // ✨ NEW: Whether this is a warmup set
